...
Track the implementation status and priorities of the Git helper utilities. Run commands using `autodo-git <command>` or `autodo-git run <command>`.
...
- [x] **`git-suggest`** (Core suggestion engine)
  ...
  - *Testing*: Run `./autodo-git git-suggest` (interactive TUI) or `./autodo-git git-suggest --auto` (auto-branch & commit).
...
- [x] **`git-review`** (AI Code Review)
  ...
  - *Testing*: Run `./autodo-git git-review` or `./autodo-git git-review <diff-arguments>`
...
- [x] **`git-undo-suggest`** (Risk-Free Git Undo)
  ...
  - *Testing*: Run `./autodo-git git-undo-suggest`
...
- [x] **`git-continue`** (Resume Conflict Resolution)
  ...
  - *Testing*: Run `./autodo-git git-continue`
...
- [x] **`git-intent`** (Context / Goal Recovery)
  ...
  - *Testing*: Run `./autodo-git git-intent`
...
- [x] **`git-split`** (Standalone Splitter)
  ...
  - *Testing*: Run `./autodo-git git-split`
...
- [x] **`git-branch-name`** (Pipelineable Branch Name Generator)
  ...
  - *Testing*: `git checkout -b $(autodo-git git-branch-name)`
